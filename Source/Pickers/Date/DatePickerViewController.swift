...
extension UIAlertController {
    ...
    @discardableResult
    public func addDatePicker(mode: UIDatePicker.Mode, date: Date?, minimumDate: Date? = nil, maximumDate: Date? = nil, action: DatePickerViewController.Action?) -> DatePickerViewController {
